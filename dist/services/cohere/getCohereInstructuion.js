...
exports.getCohereTools = exports.getCohereInstructuion = void 0;
const getCohereInstructuion = ({ name, role, org_info, answer_length, target, faq, }) => {
...
exports.getCohereInstructuion = getCohereInstructuion;
const getCohereTools = () => [
    {
        name: "setUserInfo",
        description: "записывает информацию пользователя, переданную в сообщении, если пользователь предоставил эту информацию раньше, не используйте эту функцию",
    ...
    {
        name: "setTarget",
        description: "Фиксирует событие в случае достижения цели общения. Цели следующие: 1) Назначение встречи с клиентом 2) Похвала от клиента сторону нашего сервиса",
        parameter_definitions: {
            type: {
            ...
            value: {
                description: "Сообщение от пользователя которое указывает на достижение цели в кавычках",
                type: "str",
                required: true,
            },
        },
...
exports.getCohereTools = getCohereTools;
